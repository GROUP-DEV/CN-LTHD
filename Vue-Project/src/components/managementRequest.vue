  <style scoped>
       .navbar{
        ...
        .location-detail .request-info{
            display: flex;
            justify-content: center;
        }
        .location-detail .request-info .close{
            position: relative;
            top: 0px;
            left: 25px;
            color: black;
   ...
   <div id="content">
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
      ...
      <div class="collapse navbar-collapse " id="navbarSupportedContent">
        <form class="form-inline my-2 my-lg-0 col-md-auto">
                      ...
                      <table class="table table-striped table-bordered">
                        ...
                        <tbody>
                          <tr v-for="Items in formdata">
                            ...
                            <td>00:00:00</td>
                            <td>
                              <select class="form-control form-control-lg" style="height:45px">
                                    <option>not located</option>
        ...
        data(){
          var name = JSON.parse(localStorage.getItem('key'));
            return {
                ...
                isclose: '',
                formdata:[
                          {ID:1,Name:'truongvanhau911995@gmail.com',Phone:'0389194022',Address:'227 Nguyễn Văn Cừ, phường 4, Quận 5, Hồ Chí Minh, Việt Nam',Note:'xin chào mọi người'},
                          {ID:2,Name:'Hậu hero',Phone:'0389194021',Address:'384 lý thái tổ, phương 10, quận 10, tp.hồ chí minh',Note:'xin chào mọi người'},
                          {ID:3,Name:'Hậu 2',Phone:'0389194077',Address:'500 lý thái tổ, phương 12, quận 10, tp.hồ chí minh',Note:'xin chào mọi người'},
                          ],
